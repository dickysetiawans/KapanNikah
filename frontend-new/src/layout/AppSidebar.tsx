...
const AppSidebar: React.FC = () => {
  ...
  if (isAdmin){
    if(!navItems.some((item) => item.name === "Setting")){
       navItems.push({
        name: "Setting",
        icon: <SettingIcon />,
        subItems: [
    ...
    if(!navItems.some((item) => item.name === "Tables")){
       navItems.push({
        name: "Tables",
        icon: <TableIcon />,
        subItems: [
    ...
    if(!othersItems.some((item) => item.name === "Pelanggan")){
      othersItems.push(
        {
            icon: <UserCircleIcon />,
            name: "Pelanggan",
          ...
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              ...
              <img
                ...
                src="/images/logo/logo-kapan-nikah.png"
                alt="Logo"
                width={150}
                height={144}
              />
